...
data_visitDuration = 'M_TotalVisitDurationSongs.tsv'
data_visitCount = 'M_VisitCountSongs.tsv'
data_fixationCount = 'M_FixationCountSongs.tsv'
...
set terminal qt 0 title 'Visit Duration (Songs)' position 0,10
set title "Visit Duration (Songs)" font "Times-Roman, 14"
...
set terminal qt 1 title 'Visit Count (Songs)' position 600,10
set title "Visit Count (Songs)" font "Times-Roman, 14"
...
set terminal qt 2 title 'Fixation Count (Songs)' position 1200,10
set title "Fixation Duration (Songs)" font "Times-Roman, 14"
